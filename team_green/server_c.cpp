/**
 * @file server_c.cpp
 * @brief Process C - Team Green Worker Server (C++)
 * 
 * Worker process that handles queries for Team Green data subset
 */
 ...
 * @brief Implementation of FireQueryService for Process C (Worker)
 */
...
public:
     ...
     * Receives queries from team leader (Process B)
     */
...
int main(int argc, char** argv) {
    if (argc != 2) {
        ...
        std::cerr << "Example: " << argv[0] << " ../configs/process_c.json" << std::endl;
        return 1;
    }
